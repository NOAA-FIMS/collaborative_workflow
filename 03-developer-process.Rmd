...
```{r eval = FALSE}
$ git checkout -b feat-issue-3-R-package-skeleton main  #creates a local branch
$ git push origin feat-issue-3-R-package-skeleton       #pushes branch back to gitHub
```
...
```{r eval = FALSE}
$ git push --set-upstream origin feat-issue-3-R-package-skeleton  #pushes change to feature branch on gitHub
```
