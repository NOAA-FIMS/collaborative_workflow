...
3. Open your Command Prompt and type `cmake`. If you see details of usage, cmake is already in your PATH. If not, follow the follow the instructions below to add cmake to your PATH.
...
4. You may need to restart your computer to updat the envirionmental variables.
