# Developer Software Guide This section describes the software you will
...
```{R eval = FALSE} gcc: fatal error: no input files compilation
terminated. ```
