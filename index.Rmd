...
This is a book written in **Markdown** describing the FIMS development
 ...
 living document and will change over time as the FIMS project matures.
  ...
  contributions may be made via the FIMS github site 
  <https://github.com/NOAA-FIMS>. This section describes how to edit 
...
4. Pushing to the remote feature branch initiates a Github action that
 creates a .zip file you should download and open to preview the 
 rendered .html content.
5. When you are satisfied with the changes, submit a pull request to 
